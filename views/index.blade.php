            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="event_planning.html">Event Planning</a></li>
                        <li><a class="dropdown-item" href="on-site-management.html">Onsite Management</a></li>
                        <li><a class="dropdown-item" href="design-decor.html">Design & Decor</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"><b>Portfolio</b></a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="portfolio.html">Our Portfolio</a></li>
                        <li><a class="dropdown-item" href="elegant_garden_wedding.html">Elegant Garden Wedding</a></li>
                        <li><a class="dropdown-item" href="portfolio-corporate-gala.html">Corporate Annual Gala</a></li>
                        <li><a class="dropdown-item" href="portfolio-product-launch.html">Product Launch Events</a></li>
                    </ul>
                </li>
                <li class="nav-item"><a class="nav-link" href="team.html"><b>TEAM</b></a></li>
                <li class="nav-item"><a class="nav-link" href="contact.html"><b>CONTACT</b></a></li>
                <li class="nav-item"><a class="btn btn-outline-warning text-dark btn-sm me-2" href="signup.html"><b>SIGNUP</b></a></li>
                <li class="nav-item"><a class="btn btn-outline-warning text-dark btn-sm me-2" href="login.html"><b>LOGIN</b></a></li>
            </ul>
        </div>
    </nav>  
    <section>
...
<!-- Contact Section (Link to separate contact page) -->
    ...
    <div class="container mt-5 mb-5">
        <div class="row bg-black">
            <div class="col-md-12 text-center pb-4 lead text-lg">
                ...
                <p class="text-white">For queries, please visit our <a href="contact.html" class="text-warning"><b>Contact Page</b></a> for more details.</p>
            </div>
        </div>
    </div>
</section>
